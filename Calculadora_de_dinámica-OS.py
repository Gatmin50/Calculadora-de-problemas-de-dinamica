...
def problemas_de_trabajo_energia():
    ...
    def Circular():
        ...
        etiqueta_velocidad = tk.Label(ventana8, text='velocidad (m/s)', bg="black", fg="white")
        etiqueta_velocidad.grid(row=3, column=0, padx=10, pady=10)
        ...
        etiqueta_inclinacion_del_plano = tk.Label(ventana8, text='Inclinacion del \n plano', bg="black", fg="white")
        etiqueta_inclinacion_del_plano.grid(row=3, column=4, padx=10, pady=10)
        ...
        inclinacion_del_plano = tk.Entry(ventana8)
        inclinacion_del_plano.grid(row=3, column=5, padx=10, pady=10)
        ...
        etiqueta_seleccion = tk.Label(ventana8, text="Trabajo en una:", bg="black", fg="white")
        ...
        #Botones
        Calcular_w = tk.Button(ventana8, text="Calcular W", command=lambda:(seleccionar_opcion()), bg="white", fg="black")
        Calcular_w.grid(row=4, column=0, padx=10, pady=10) 
