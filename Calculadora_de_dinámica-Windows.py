...
def programa_plano_inclinado():
    ...
    rectangulo = lienzo.create_rectangle(95, 132, 115, 152, fill='lightgreen')
    rectangulo = lienzo.create_rectangle(95, 280, 115, 300, fill='red')
    rectangulo = lienzo.create_rectangle(270, 230, 290, 250, fill='gold')
    rectangulo = lienzo.create_rectangle(270, 280, 290, 300, fill='blue')
...
def programa_plano_inclinado_con_dos_cuerpos():
    ...
    ventana2.geometry('1400x750+0+0')
    ...
    #Detalles gráficos
    lienzo = tk.Canvas(ventana2, width=1400, height=750)
    lienzo.configure(bg='black')
    lienzo.pack()
    ...
    def calcular_aceleraciónfm1():
        ...
        try:
            ...
            z = -1
            a = z * (g * ((m1 * math.sin(math.radians(cos1))) - (mu1 * m1 * math.cos(math.radians(cos1))) + (m2 * math.sin(math.radians(cos2))) - (mu2 * m2 * math.cos(math.radians(cos2)))))
            ax = a * z
            x = a / (m1 + m2)
            resultado4 = round(x, 3)
            if resultado4 >= 0:
    ...
    def calcular_aceleraciónfm2():
        ...
        try:
            ...
            mu2 = float(friccion2.get())
            z = 1
            a = (g * ((-m1 * math.sin(math.radians(cos1))) - (mu1 * m1 * math.cos(math.radians(cos1))) + (m2 * math.sin(math.radians(cos2))) - (mu2 * m2 * math.cos(math.radians(cos2)))))
            ax = a * z
            x = ax / (m1 + m2)
            resultado4 = round(x, 3)
            if resultado4 >= 0:
...
def mini_calculadora():
    ...
    btn_1 = tk.Button(ventana3, text=" 1 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("1"), bg="white", fg="black")
    btn_1.grid(column=0, row=3, columnspan=1, padx=10, pady=10)

    btn_2 = tk.Button(ventana3, text=" 2 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("2"), bg="white", fg="black")
    btn_2.grid(column=1, row=3, columnspan=1, padx=10, pady=10)

    btn_3 = tk.Button(ventana3, text=" 3 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("3"), bg="white", fg="black")
    btn_3.grid(column=2, row=3, columnspan=1, padx=10, pady=10)

    btn_4 = tk.Button(ventana3, text=" 4 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("4"), bg="white", fg="black")
    btn_4.grid(column=0, row=2, columnspan=1, padx=10, pady=10)

    btn_5 = tk.Button(ventana3, text=" 5 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("5"), bg="white", fg="black")
    btn_5.grid(column=1, row=2, columnspan=1, padx=10, pady=10)

    btn_6 = tk.Button(ventana3, text=" 6 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("6"), bg="white", fg="black")
    btn_6.grid(column=2, row=2, columnspan=1, padx=10, pady=10)

    btn_7 = tk.Button(ventana3, text=" 7 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("7"), bg="white", fg="black")
    btn_7.grid(column=0, row=1, columnspan=1, padx=10, pady=10)

    btn_8 = tk.Button(ventana3, text=" 8 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("8"), bg="white", fg="black")
    btn_8.grid(column=1, row=1, columnspan=1, padx=10, pady=10)

    btn_9 = tk.Button(ventana3, text=" 9 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("9"), bg="white", fg="black")
    btn_9.grid(column=2, row=1, columnspan=1, padx=10, pady=10)

    btn_0 = tk.Button(ventana3, text=" 0 ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("0"), bg="white", fg="black")
    btn_0.grid(column=0, row=4, columnspan=1, padx=10, pady=10)

    btn_10 = tk.Button(ventana3, text=" - ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("-"), bg="white", fg="black")
    btn_10.grid(column=4, row=3, columnspan=1, padx=10, pady=10)

    btn_11 = tk.Button(ventana3, text=" + ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("+"), bg="white", fg="black")
    btn_11.grid(column=3, row=3, columnspan=1, padx=10, pady=10)

    btn_12 = tk.Button(ventana3, text=" X ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("*"), bg="white", fg="black")
    btn_12.grid(column=3, row=2, columnspan=1, padx=10, pady=10)

    btn_13 = tk.Button(ventana3, text=" / ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("/"), bg="white", fg="black")
    btn_13.grid(column=4, row=2, columnspan=1, padx=10, pady=10)

    btn_14 = tk.Button(ventana3, text=" = ", font=("Helvetica", 10, "bold"), command=hacer_operación, bg="gold", fg="black")
    btn_14.grid(column=4, row=4, columnspan=1, padx=10, pady=10)

    btn_15 = tk.Button(ventana3, text=" · ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("."), bg="white", fg="black")
    btn_15.grid(column=1, row=4, columnspan=1, padx=10, pady=10)

    btn_16 = tk.Button(ventana3, text=" Ac ", font=("Helvetica", 10, "bold"), command=elimina_todo, bg="blue", fg="white")
    btn_16.grid(column=4, row=1, columnspan=1, padx=10, pady=10)

    btn_17 = tk.Button(ventana3, text=" Del ", font=("Helvetica", 10, "bold"), command=elimina_el_ultimo, bg="blue", fg="white")
    btn_17.grid(column=3, row=1, columnspan=1, padx=10, pady=10)

    btn_18 = tk.Button(ventana3, text=" ( ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter("("), bg="white", fg="black")
    btn_18.grid(column=2, row=4, columnspan=1, padx=10, pady=10)

    btn_19 = tk.Button(ventana3, text=" ) ", font=("Helvetica", 10, "bold"), command=lambda: añadir_caracter(")"), bg="white", fg="black")
...
combobox = ttk.Combobox(ventana1, values=opciones)
combobox.grid_remove()
combobox.bind("<<ComboboxSelected>>", seleccionar_opcion)
etiqueta_resultado = tk.Label(ventana1, text="", bg="black", fg="white")
etiqueta_resultado.grid_remove()
etiqueta_seleccion = tk.Label(ventana1, text="Selecciona una opcion:", bg="black", fg="white")
...
boton_calculadora.grid(column=2, row=3, columnspan=2, padx=10, pady=10)
boton_calculadora_te = tk.Button(ventana1, text="Problemas de trabajo y energía", command=traspaso1 , font=("Helvetica", 15, "bold"), bg="darkblue", fg="white")
boton_calculadora_te.grid(column=3, row=3, columnspan=2, padx=10, pady=10)
