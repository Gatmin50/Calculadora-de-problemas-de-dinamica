...
def programa_plano_inclinado():
    ...
    rectangulo = lienzo.create_rectangle(250, 230, 270, 250, fill='gold')
    rectangulo = lienzo.create_rectangle(250, 280, 270, 300, fill='blue')
...
def programa_plano_inclinado_con_dos_cuerpos():
    ...
    btn_cerrar.grid(column=2, row=10, columnspan=2, padx=10, pady=10)
...
def problemas_de_trabajo_energia():
    ...
    ventana4.geometry('1300x650+100+100')
    ...
    opciones = ["Vertical", "Plano", "Inclinado", "Circular", "Semi cicular"]
    ...
    def Vertical():
        ...
        ventana5.geometry('830x250+550+150')
        ...
        etiqueta_masa.grid(row=0, column=2, columnspan=2, padx=10, pady=10)
        ...
        etiqueta_resultado.grid(row=3, column=3, padx=10, pady=10)
        etiqueta_resultado1 = tk.Label(ventana5, text='', bg="black", fg="white")
        etiqueta_resultado1.grid(row=1, column=4, padx=10, pady=10)
        etiqueta_resultado2 = tk.Label(ventana5, text='', bg="black", fg="white")
        etiqueta_resultado2.grid(row=2, column=4, padx=10, pady=10)
        etiqueta_resultado3 = tk.Label(ventana5, text='', bg="black", fg="white")
        etiqueta_resultado3.grid(row=3, column=4, padx=10, pady=10)
        ...
        Calcular_H_max.grid(row=3, column=0, padx=10, pady=10)
        ...
        Calcular_h_a_velocidad_media.grid(row=3, column=1, padx=10, pady=10)
        ...
        Calcular_v_impact.grid(row=3, column=2, padx=10, pady=10)
    ...
    def Semi_cicular():
        ventana9 = tk.Tk()
        ventana9.title("Trabajo y energia semi circular")
        ventana9.geometry('1300x650+100+100')
...
boton_calculadora_de_trabajo_energia = tk.Button(ventana1, text="Calculadora de trabajo y energia", command=problemas_de_trabajo_energia , font=("Helvetica", 15, "bold"), bg="darkblue", fg="white")
boton_calculadora_de_trabajo_energia.grid(column=4, row=3, columnspan=2, padx=10, pady=10)
